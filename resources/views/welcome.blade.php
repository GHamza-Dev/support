        ...
        <div class="flex-col gap-10 lg:flex lg:flex-row-reverse items-center justify-center">
            ...
            <div class="text-center lg:text-left">
                ...
                <div class="mt-4 lg:mt-7">
                    <button class="border rounded-full bg-blue-500 text-white py-2 px-3 font-semibold hover:bg-blue-700 ease-linear transition-colors duration-200"><a href="{{ route('create.ticket') }}">Add a Ticket</a></button>
